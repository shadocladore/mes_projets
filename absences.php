...
<?php include("entete.php"); ?>
			<div id="repere">
				<span class="nom-page">Liste Absences</span>
				<span class="lien"><a href="accueil-app-gestion-school.php">Accueil</a> > <i>Employés Absents</i></span> 
			</div>
			<div id="corps">
				...
				<a href="absences_impression.php" id="impression" class="imprimer" title="Imprimer une liste d'employés absents">
				...
				<form action="recherche_absence.php" method="post" id="search">
					<p>
						<input type="search" value="<?php echo @$_POST['recherche']; ?>" name="recherche" required size="40" placeholder="Rechercher un employé par son nom ou grade..."/>
				...
				<th>Date fin<br/> d'absence</th><th>Nbre de jours<br/> d'absence</th><th>Date Reprise <br/>Service</th><th>Opérations</th>
				</tr>
					<?php 
...
$query = "SELECT COUNT(id_absence) AS numrows from absence";
...
?>
	<?php
		$requete = "SELECT * FROM absence, employe where absence.id_employe = employe.id_employe order by id_absence DESC LIMIT $offset, $rowsPerPage ";
		...
		while($data = mysqli_fetch_array($reponse)) {
			...
			echo "<tr>
				...
				<td>".$data['date_debut']."</td><td>".$data['date_fin']."</td><td>".$data['nbre_jour_absence']."</td><td>".$data['date_reprise_service']."</td>";
	?>
			<td width="100">
...
<!-------- Page d'inscription ------>
		<div id="page-inscription" class="page_form" >
			<form action="ajouter_absence.php" method="post" id="form-inscription">
				<a id="close" href="#"><img src="images/close.png" class="close" width="13" height="15" /></a><h3><em>AJout employé absent</em></h3>
			...
			?></select></p>
				<p><span>Motif de l'absence</span><input type="text" placeholder=" ex: Maladie"  maxlength="35" name="motif" required/></p>
				<p><span>Date début d'absence</span><input type="text" maxlength="10" name="date_debut"  placeholder="03/11/2023" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01])[/](0[1-9]|1[012])[/][0-9]{4}" required/></p>
				<p><span>Date fin d'absence </span><input type="text" maxlength="10" name="date_fin" placeholder="03/11/2023" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01])[/](0[1-9]|1[012])[/][0-9]{4}"/></p>
				<p><span>Nbre de Jour(s) d'absence </span><input type="number" maxlength="3" name="nbre_jour_absence" placeholder=" 4" /></p>
				<p><span>Date reprise service </span><input type="text"  maxlength="10"  name="date_reprise_service" placeholder="03/11/2023" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01])[/](0[1-9]|1[012])[/][0-9]{4}"/></p>
